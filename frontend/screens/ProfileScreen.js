...
//         const response = await fetch('http://192.168.0.2:3002/get-profile');
...
//     try {
//       const response = await fetch('http://192.168.0.2:3002/change-password', {
//         method: 'POST',
...
//         <Text style={styles.footerText}>© 2025 SkillQuest. All rights reserved.</Text>
//       </ScrollView>
//     </View>
//   );
// }
...
//   },
//   card: {
//     width: '104%', backgroundColor: 'snow', borderRadius: 15,
...
const styles = StyleSheet.create({
  stickyHeader: {
    position: 'absolute', top: 0, left: 0, right: 0,
    paddingTop: 30, paddingBottom: 12, paddingHorizontal: 24,
    zIndex: 10, backgroundColor: 'snow',
  ...
  pageHeaderText: { fontSize: 24, fontWeight: 'bold', color: '000' ,marginTop:5,marginLeft:'40%',},
  profileSection: { alignItems: 'center', marginBottom: 10 ,},
  imageWrapper: { position: 'relative' },
  profileImage: {
    width: 110, height: 110, borderRadius: 55,
  ...
  userName: { fontSize: 23, fontWeight: 'bold', color: '#fff' },
  sectionTitle: {
    fontSize: 21, fontWeight: '600',
    alignSelf: 'flex-start', marginTop: -10, marginBottom: 6, color: 'black',
    paddingTop:7,
    paddingBottom:5,
  },
  card: {
  ...
  logoutText: { color: '#fff', fontWeight: '600', fontSize: 18 },
  footerText: { fontSize: 15, color: 'black', marginBottom: 85 },
  modalOverlay: {
    flex: 1, backgroundColor: 'rgba(0,0,0,0.5)',
    justifyContent: 'center', alignItems: 'center',
  },
